    ...
    return(
        <div className="w-screen h-screen">
            ...
            <div className=" Headline h-1/3 w-full bg-red-700 flex items-center justify-between px-24 rounded-bl-[150px]">
                <div className="w-1/2">
                    <p className="text-white tracking-wide text-[80px] font-bold mb-3">Discover & Bid</p>
                    <p className="text-orange-300 text-2xl font-semibold ">From wide range of events posted by users!</p>
                </div>
            ...
            <div className="flex cols grid-cols-5 mt-10 ml-10">
                <label htmlFor="my-modal-4" className="btn h-36 w-96 bg-slate-300 ">
                    ...
                    <div class="relative w-24 h-24 overflow-hidden bg-gray-100 rounded-full dark:bg-gray-600 -left-[20px]">
                            <svg class="absolute w-28 h-28 text-gray-400 -left-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clip-rule="evenodd"></path></svg>
                    </div>

                    <div className="p-4">
                        <div className="text-center text-2xl font-semibold">Post Headline</div>
                    ...
                    <label htmlFor="my-modal-4" className="modal cursor-pointer">
                        ...
                        <label className="modal-box relative max-w-5xl h-[700px]" htmlFor="">
                            ...
                            <div className="text-4xl text-center text-black  p-3 rounded-xl">
                                ...
                                <span class="w-[824px] h-px my-5 bg-gray-200 border-0 dark:bg-gray-700"> </span>
                                </div>

            

            <div class="Review flex flex-col items-top justify-left w-1/2 h-96  overflow-y-auto overflow-x-hidden pl-6">
            <div class="ratingcomp flex flex-col justify-center w-96 p-4  ">
                <div className="text-xl font-semibold mb-6 ml-2">Bids so far</div>
              <div className="p-5 bg-slate-300 shadow rounded-xl transition ease-in-out flex items-center delay-150 hover:-translate-y-1 hover:text-white hover:scale-105 hover:bg-black hover duration-300 mb-2 justify-between">
                <div>bid 1</div>
                <div className="text-base font-semibold flex text-green-600 items-center"><TbCurrencyRupee/>10000<div></div></div>
              </div>
              <div className="p-5 bg-slate-300 shadow rounded-xl transition ease-in-out flex items-center delay-150 hover:-translate-y-1 hover:text-white hover:scale-105 hover:bg-black hover duration-300 mb-2 justify-between">
                <div>bid 2</div>
                <div className="text-base font-semibold flex text-green-600 items-center"><TbCurrencyRupee/>10000<div></div></div>
