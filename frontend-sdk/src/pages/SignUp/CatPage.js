    ...
    <React.Fragment>
      ...
      <div className="flex flex-col lg:flex-row items-center p-4 bg-white h-screen">
        <div className="w-full lg:w-[50vw] h-screen hidden lg:flex flex-col items-center justify-center p-12 bg-no-repeat bg-cover bg-white rounded-l-2xl ">
          ...
          <br></br>
          <div class=" w-96 h-8 bg-gradient-to-r from-phorange absolute inset-y-64 left-0 "></div>
          <br></br>
          ...
          <div class=" w-72 h-8 bg-gradient-to-r from-phorange absolute inset-y-80 left-0 "></div>
          <br></br>
          ...
          <div class=" w-3/12 h-8 bg-gradient-to-r from-phorange absolute inset-y-96 left-0 "></div>
          <br></br>

          <div class=" w-72 h-8 bg-gradient-to-r from-phorange absolute inset-y-[448px] left-0 "></div>
          <br></br>
          {/* <div class=" w-5/12 h-8 bg-gradient-to-r from-phorange absolute inset-y-[448px] left-0 " ></div><br></br> */}
          <div class=" w-96 h-8 bg-gradient-to-r from-phorange absolute inset-y-[512px] left-0 "></div>
          <br></br>
          <div class=" w-1/4 h-8 bg-gradient-to-r from-phorange absolute inset-y-[576px] left-0 "></div>
          <br></br>
          <div class=" w-1/3 h-8 bg-gradient-to-r from-phorange absolute inset-y-[640px] left-0 "></div>
          <br></br>
          <div class=" w-96 h-8 bg-gradient-to-r from-phorange absolute inset-y-[704px] left-0 "></div>
          <br></br>
          <div class=" w-5/12 h-8 bg-gradient-to-r from-phorange absolute inset-y-[768px] left-0 "></div>
          <br></br>
        </div>
