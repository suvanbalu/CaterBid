    ...
    return (
      ...
      >
        <div className="relative flex flex-col items-center text-teal-600 h-24">
          ...
          <div className={`absolute-top-0 text-center w-14 text-sm font-medium uppercase  ${step.highlighted ? "text-gray-900" : "text-gray-400"}`}>
            {/* {display description} */}
            {step.description}
          </div>
        ...
        <div className={`flex-auto justify-content-center border-2 transition mb-12 duration-500 ease-in-out ${step.completed ? "border-green-600": "border-gray-300"}`}>
        </div>
