    ...
    return (
        <div class="p-10 m-0">
            <div class="p-8 bg-white shadow ">
                ...
                <div class="grid md:grid-cols-2 px-24 items-center space-x-12">
                    ...
                    <div class="bg-white shadow mt-12">
                        ...
                        <div class="grid md:grid-cols-2 px-48 space-y-7">

                            <button class="grid md:grid-rows-2 justify-center rounded-full bg-slate-300 h-24 w-24 mt-7 hover:bg-blue-300 duration-300 transition ease-in-out delay-150 hover:-translate-y-1">
                                <div class="font-bold text-gray-700 text-3xl m-auto"><CiMail/></div>
                                <div class="text-gray-400">Mail</div>
                        
                            </button>


                            <button class="grid md:grid-rows-2 justify-center rounded-full bg-slate-300  h-24 w-24 hover:bg-orange-300 duration-300 transition ease-in-out delay-150 hover:-translate-y-1">

                                <div class="font-bold text-gray-700 text-3xl m-auto"><SiGooglemaps/></div>
                                <div class="text-gray-400">Maps</div>
                            </button>


                            <button class="grid md:grid-rows-2 justify-center rounded-full bg-slate-300  h-24 w-24 hover:bg-yellow-300 duration-300 transition ease-in-out delay-150 hover:-translate-y-1">

                                <div class="font-bold text-gray-700 text-3xl m-auto"><AiOutlineInstagram/></div>
                                <div class="text-gray-400">Instagram</div>
                            </button>


                            <button class="grid md:grid-rows-2 justify-center rounded-full bg-slate-300  h-24 w-24  hover:bg-purple-300 duration-300 transition ease-in-out delay-150 hover:-translate-y-1" >
                                <div class="font-bold text-gray-700 text-3xl m-auto"><AiOutlineFacebook/></div>
