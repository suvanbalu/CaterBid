...
const HowItWorks = () => {
    return (
      <React.Fragment>
        ...
        <section className='h-screen w-full p-4  flex-col '
        style={{
            backgroundImage:
              "linear-gradient(to bottom left, rgba(220, 229, 230, 0.2), rgba(0, 50, 35, 0.7)), url(https://images.unsplash.com/photo-1533143708019-ea5cfa80213e?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=3000&q=80)",
                ...
                <div className='desc_text text-white text-center'>            
                    <h1 class="font-mont tracking-tight text-white text-3xl pt-10">     
                        <p class="p-2 break-words">                       
                            It's as simple as an order form. 
                        </p>
                        <p>
                            You tell us what you want, and the best caterers compatible with your needs will find you.
                            Quickly and easily. No more searching through hundreds of caterers. No more calling around. No more wasting time.
                        </p>
                    </h1>
                </div>
              ...
              <Link to="/HowItWorks">I'm a caterer</Link>
              </button>
                </div>
