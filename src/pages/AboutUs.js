...
const AboutUs = () => {
  ...
  return (
    <section className="bg-white h-full w-full p-4 m-1 flex-col justify-center">
        ...
        <div className="maingrid grid grid-cols-3 text-center space-x-4 lg:grid-cols-5 m-4 h-full w-full p-4 justify-center">
          <div className="suvangrid border-black border-2 rounded shadow-md bg-white-500 hover:bg-slate-300 ">
            <img
          ...
          <div className="team-item border-black border-2 rounded shadow-md bg-white-500 hover:bg-slate-300">
            <img
              src="https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460__340.png"
              className="team-img rounded-t-full"
              alt="pic"
            />
          ...
          <div className="team-item border-black border-2 rounded shadow-md bg-white-500 hover:bg-slate-300">
            <img
              src="https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460__340.png"
              className="team-img rounded-full "
              alt="pic"
            />
            <br></br>
            ...
            <div className="mt-4 flex justify-center space-x-0">
              <div class="p-2">
                <div class="group relative w-max">
                  ...
                  <span class="pointer-events-none absolute h-full w-full flex justify-center  opacity-0 transition-opacity group-hover:opacity-100 bg-slate-600 rounded-2xl p-1 text-white">
                    Github
                  </span>
                </div>
              </div>
              ...
              <div class="p-2">
                <div class="group relative w-max">
                  ...
                  <span class="pointer-events-none absolute h-full w-full flex justify-center opacity-0 transition-opacity group-hover:opacity-100 bg-red-600 rounded-xl p-1 text-white">
                    Instagram
                  </span>
                </div>
              </div>
              ...
              <div class="p-2">
                <div class="group relative w-max">
                  ...
                  <span class="pointer-events-none absolute h-full w-full flex justify-center opacity-0 transition-opacity group-hover:opacity-100 bg-sky-600 rounded-2xl p-1 text-white ">
                    Linkedln
                  </span>
                </div>
              </div>
