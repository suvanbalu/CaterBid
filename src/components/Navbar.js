...
const Navbar = () => {
    return (
        ...
        className='bg-white mobile:px-2 mobile:my-1 sm:px-4 lg:px-[calc(100vw/20)] py-1 font-sans  flex items-center sm:justify-between'>
            <div className='flex items-center mobile:justify-center sm:justify-start w-1/3 mobile:space-2 m-1 space-x-4 mobile:space-x-2'>
            <img
                ...
                <h1 className = "sm:text-2xl mobile:text-xl font-bold text-red-500"> CaterBid </h1>
            </div>
            <div className='flex items-center m-4 mobile:m-1 space-x-4 mobile:pr-2 mobile:space-x-2 w-1/3 px-12 mobile:px-8 justify-center'>
                <button className='uppercase font-mont mobile:text-xs sm:text-base'>How it Works</button>
                <p className='uppercase font-mont'>|</p>
                <button className='uppercase font-mont mobile:text-xs sm:text-base '>
